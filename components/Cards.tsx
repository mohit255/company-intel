  ...
  if (src) {
    return (
      ...
      <img src={src} alt={alt} loading="lazy"
           className="aspect-video w-full rounded-xl border border-zinc-800
...
const cardClass = `group flex flex-col gap-2.5 rounded-2xl border
    border-zinc-800 bg-zinc-900/60 p-5 transition
  ...
  return (
    <a href={item.link} target="_blank" rel="noopener noreferrer"
      ...
      <h3 className="font-serif text-lg leading-snug text-zinc-100
          transition group-hover:text-amber-300">
        {item.title}
      </h3>
